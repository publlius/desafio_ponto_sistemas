...
class UsuarioList extends TPage
{
    ...
    private static $formName = 'formList_Usuario';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de usuários");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['UsuarioForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $column_id->setTotalFunction( function($values) { 
            return count((array) $values); 
        }); 

        $column_idade->setTotalFunction( function($values) { 
        ...
        $order_data_nascimento_transformed = new TAction(array($this, 'onReload'));
        $order_data_nascimento_transformed->setParameter('order', 'data_nascimento');
        $column_data_nascimento_transformed->setAction($order_data_nascimento_transformed);
        ...
        $action_onDelete = new TDataGridAction(array('UsuarioList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Usuários"]));
